				...
				<tr>
					...
					<td class="col-md-3">
						<div class="pull-left">
							...
							<a href="{{ URL::to('administrator/post/trash/') }}/{{ $a->id }}/{{ md5($a->id) }}" class="btn btn-danger btn-xs"><span class="glyphicon glyphicon-trash"></span> Trash</a>							
						</div>
					</td>
				</tr>
				@empty
				...
				<tr>
					...
					<td class="col-md-3">
						<div class="pull-left">
							...
							<a href="{{ URL::to('administrator/post/trash/') }}/{{ $publish->id }}/{{ md5($publish->id) }}" class="btn btn-danger btn-xs"><span class="glyphicon glyphicon-trash"></span> Trash</a>							
						</div>
					</td>
				</tr>
				@empty
				...
				<tr>
					...
					<td class="col-md-3">
						<div class="pull-left">
							...
							<a href="{{ URL::to('post/' . $draft->id) }}" target="_blank" class="btn btn-info btn-xs"><span class="glyphicon glyphicon-eye-open"></span> View</a> 
							<a href="{{ URL::to('administrator/post/trash/') }}/{{ $draft->id }}/{{ md5($draft->id) }}" class="btn btn-danger btn-xs"><span class="glyphicon glyphicon-trash"></span> Trash</a>							
						</div>
					</td>
				</tr>
				@empty
		...
		<table class="table table-hover table-bordered">
			...
			<tbody>
				...
				<tr>
					...
					<td class="col-md-3">
						<div class="pull-left">
							<a href="{{ URL::to('administrator/post/' . $trash->id . '/edit') }}" class="btn btn-success btn-xs"><span class="glyphicon glyphicon-edit"></span> Restore</a>						
						</div>
					</td>
				</tr>
				@empty
